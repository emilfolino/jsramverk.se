...
Börja därför med att ladda ner appen [emilfolino/train-controller](https://github.com/emilfolino/train-controller/releases/tag/v1.0), som en zip-fil. Skapa sedan ett eget Git och GitHub repo utifrån den koden. Till exempel utifrån [Git guides](https://github.com/git-guides/git-init).
